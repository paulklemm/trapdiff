...
3. Check the CPMs for the DE genes of the interaction term in the **DE Interaction Gene Plots**
...
Additionally, we filter `r genes_regex_filtered %>% length()` genes manually with regex `r rmd_params$filter_regex`.
