...
plot %>%
  plotly::ggplotly() %>%
  plotly::highlight(dynamic = TRUE, selectize = TRUE)
```
...
plot <- dplyr::left_join(
  ...
  dplyr::filter(gene_id %in% c("ENSMUSG00000000003_Pbsn", "ENSMUSG00000000103_Zfy2", "ENSMUSG00000000157_Itgb2l", "ENSMUSG00000000183_Fgf6", "ENSMUSG00000000215_Ins2", "ENSMUSG00000000318_Clec10a", "ENSMUSG00000000381_Wap", "ENSMUSG00000000544_Gpa33", "ENSMUSG00000000606_Vmn2r88", "ENSMUSG00000000617_Grm6")) %>%
  crosstalk::SharedData$new(~gene_id, group = "Choose a gene") %>%
  violin_plot()
